              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-4">
                    ...
                    You can combine text search with specific filters and logical operators
                    to find exactly what you need.
                  </p>
                  <div className="bg-muted p-4 rounded-lg">
                    <p className="text-sm font-mono">
                      <span className="text-blue-600">type:course</span>{" "}
                      <span className="text-gray-600">AND</span>{" "}
                      <span className="text-green-600">&quot;Data Structures&quot;</span>{" "}
                      <span className="text-gray-600">AND</span>{" "}
                      <span className="text-purple-600">college:IT</span>
                    </p>
            ...
            <Card className="p-6">
              ...
              <ul className="space-y-2 text-muted-foreground">
                ...
                <li className="flex items-start gap-2">
                  ...
                  <code className="bg-muted px-1 rounded">
                    (type:course OR type:degree) college:IT
                  </code>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-primary">•</span>
                  Fields are case-insensitive:{" "}
                  <code className="bg-muted px-1 rounded">TYPE:COURSE</code>
                  {" "}works the same as{" "}
                  <code className="bg-muted px-1 rounded">type:course</code>
                </li>
                <li className="flex items-start gap-2">
