  ...
  try {
    ...
    const sampleCourses = {
      "C182": {
        ...
        "description": [
          "This course introduces students to information technology as a discipline",
          "and the various roles and functions of the IT department as business support.",
          "Students are presented with various IT disciplines including systems and services,",
          "network and security, scripting and programming, data management, and the business",
          "of IT, with a survey of technologies in every area and how they relate to each",
          "other and to the business.",
        ].join(" "),
        "ccn": "ITEC 1010",
        "competencyUnits": 4,
      ...
      "C867": {
        ...
        "description": [
          "This course provides an introduction to programming covering data structures,",
          "algorithms, and programming paradigms. The course presents the student with the",
          "concept of an object as well as the object-oriented paradigm and its benefits.",
          "A survey of languages is covered and the distinction between interpreted and",
          "compiled languages is introduced.",
        ].join(" "),
        "ccn": "COMP 1671",
        "competencyUnits": 4,
        "courseType": "degree-plan",
      ...
      "C958": {
        ...
        "description": [
          "This course covers single-variable calculus including limits, derivatives,",
          "and integrals with applications. Topics include exponential, logarithmic,",
          "and trigonometric functions. Students will learn to apply calculus to solve",
          "real-world problems in their field of study.",
        ].join(" "),
        "ccn": "MATH 1210",
        "competencyUnits": 4,
        "courseType": "degree-plan",
